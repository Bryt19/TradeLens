...
export function FeaturesSectionWithHoverEffects() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Advanced analytics and insights to make informed trading decisions.",
    ...
    },
    {
      ...
      description:
        "Real-time updates and instant access to market data without delays.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Global Coverage",
      description:
        "Access markets and data from around the world in one platform.",
