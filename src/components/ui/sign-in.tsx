...
const TestimonialCard = ({
  ...
  <div
    className={`animate-testimonial ${delay} flex items-start gap-3 rounded-3xl bg-white/40 dark:bg-zinc-800/40 backdrop-blur-xl border border-white/10 p-5 w-64`}
  >
    <img
      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <p className="animate-element animate-delay-200 text-gray-600 dark:text-gray-400">
              {description}
            </p>
            ...
            <div className="animate-element animate-delay-300 relative flex items-center justify-center">
              ...
              <span className="px-4 text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-black absolute">
                Continue with
              </span>
            </div>
